...
import SearchBar from "../threshold/searchBar";
import ActionButtons from '../../components/actionbuttons'; // Changed to default import
import ProfileActions from '../threshold/profile';
...
export default function Header() {
  return (
    <header className="flex flex-col self-stretch w-full max-md:max-w-full">
      ...
      <div className="flex flex-wrap gap-10 justify-between items-start pl-8 mt-2 w-full text-sm max-md:px-5 max-md:max-w-full">
        <SearchBar />
        <ActionButtons onDashboardsGenerated={(dashboards) => console.log('Dashboards generated:', dashboards)} />
        <ProfileActions />
      </div>
    </header>
  );
